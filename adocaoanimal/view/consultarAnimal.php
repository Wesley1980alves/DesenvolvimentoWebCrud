...
<html lang="pt-br">
    ...
    <body>
        ...
        <form method="POST" action="validarFormulario.php">
            ...
            <label for="nome" class="form-label" <strong> <span style:"color;">Animal Que Deseja Consultar :</strong></label>
            <hr>
            ...
            ?>
            <hr>
            <button type="submit" class="btn btn-primary"><strong><span style='color:black;'>Consultar Animal</strong></span></button>
            ...
            if (isset($_POST["consultarAnimal"])) {
                require_once "Funcoes.php";
                $animal = animalSelecionar($_POST["consultarAnimal"]);

                /* var_dump($animal); */

                echo "Nome: " . $animal->nome . "<br>";
                echo "Peso:" . $animal->peso . "<br>";
                echo "Sexo:" . $animal->sexo . "<br>";
                echo "Descrição:" . $animal->descricao . "<br>";
                echo "Histórico:" . $animal->historico . "<br>";
                echo "Tipo:" . $animal->tipo . "<br>";
                echo "Status_animal:" . $animal->seu_status . "<br>";
            }
            ?>
        </form>
